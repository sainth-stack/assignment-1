          ...
          <form className="">
            <div className="planJourney">
              ...
              <div className="row d-flex justify-content-between">
                ...
                <i
                  class="fa fa-exchange d-flex align-items-center mt-4"
                  aria-hidden="true"
                ></i>
                    ...
                    return (
                      <div className="trainDetails m-1" key={index}>
                        ...
                        <div className="row train">
                          <div className="col-4">
                            ...
                            <p className="train-no">
                              {"#" + train.train_num} | Departs on:
                              <span className="text-success">S M</span>
                            </p>
                          </div>
                          <div className="col-3">
                        ...
                        <div className="row train-p-class ml-3 mb-3">
                          {train.data.classes &&
                          typeof train.data.classes === "string" ? (
                            <p>Unreserved</p>
                          ) : (
                            train.data.classes.map((classe, index) => {
                              return (
                                <div
                                  className="col-4 m-2 train-class"
                                  key={index}
                                >
                                  <div className="row">
                                    <div className="col-8">
                                      <p className="train-name">{classe}</p>
                                      <span className="seat-available text-success">
                                        AVAILABLE 12
                                      </span>
                                    </div>
                                    <div>
                        ...
                        <button
                          ...
                          onClick={() => {
                            axios
                              .post("http://localhost:5000/reserveTrain", train)
                              .then((res) => {
                                console.log(res);
                                if (res) {
